...
import valeriatamarindo.loja.services.ClientService;
...
public class ClientResource {
    ...
    public ResponseEntity<Page<ClientDTO>> findAll(
            ...
            Pageable pageable) {
            Page<ClientDTO> list = service.findAllPaged(addressId, name.trim(), pageable);
    ...
    public ResponseEntity<ClientDTO> insert(@RequestBody ClientDTO dto) {
        Set<AddressDTO> setAddressDTO = addressService.insertFromSet(dto.getAddresses());
        dto.setAddresses(setAddressDTO);
